...
class maxvit_b0(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(maxvit_b0, self).__init__(
            patch_size=4, embed_dims=[32, 64, 160, 256], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
            qkv_bias=True, norm_layer=partial(nn.LayerNorm, eps=1e-6), depths=[2, 2, 2, 2], sr_ratios=[8, 4, 2, 1],
            drop_rate=0.0, drop_path_rate=0.1)

@BACKBONES.register_module()
class b1_maxvit_8size(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(b1_maxvit_8size, self).__init__(
...
@BACKBONES.register_module()
class maxvit_b2(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(maxvit_b2, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class maxvit_b3(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(maxvit_b3, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class maxvit_b4(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(maxvit_b4, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class maxvit_b5(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(maxvit_b5, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
