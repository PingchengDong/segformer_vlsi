...
class seg_b0(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(seg_b0, self).__init__(
...
@BACKBONES.register_module()
class seg_b1(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(seg_b1, self).__init__(
...
@BACKBONES.register_module()
class seg_b2(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(seg_b2, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class seg_b3(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(seg_b3, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class seg_b4(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(seg_b4, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
...
@BACKBONES.register_module()
class seg_b5(MixVisionTransformer):
    def __init__(self, **kwargs):
        super(seg_b5, self).__init__(
            patch_size=4, embed_dims=[64, 128, 320, 512], num_heads=[1, 2, 5, 8], mlp_ratios=[4, 4, 4, 4],
